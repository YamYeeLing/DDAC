...
namespace DDAC.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CargoName,CargoWidth,CargoLength,CargoHeight,CargoWeight,CustomerId,WarehouseId,CargoRequirement")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CargoName,CargoWidth,CargoLength,CargoHeight,CargoWeight,CustomerId,WarehouseId,CargoRequirement")] Cargo cargo)
        {
            if (ModelState.IsValid)
            {
